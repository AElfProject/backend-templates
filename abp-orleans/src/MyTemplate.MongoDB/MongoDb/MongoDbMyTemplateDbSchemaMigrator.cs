...
public class MongoDbMyTemplateDbSchemaMigrator : IMyTemplateDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMyTemplateDbSchemaMigrator(IServiceProvider serviceProvider)
    {
